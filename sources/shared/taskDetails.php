...
<div class="panel-body">
	...
	<form method="post" action="" id="form-details">
		...
		<div class="form-group">
			...
			<textarea class="form-control" id="desc" rows="3" name="fDescription" placeholder="Ajoutez une description si vous le désirez." maxlength="500"><?php echo $line['task_description'];?></textarea>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="dateStart" name="fDateStart" placeholder="ex. 2017-06-15 13:15:00" value="<?php echo $line['task_plannedBeginning'];?>">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="plannedEnd" name="fPlannedEnd" placeholder="ex. 2017-06-15 13:15:00" value="<?php echo $line['task_plannedEnd'];?>">
		</div>
