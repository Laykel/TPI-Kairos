			...
			<div class="panel-body">
				<form method="post" action="">
					...
					<div class="form-group">
						...
						<input type="email" class="form-control" id="email" name="fEmail" placeholder="exemple@test.ch" maxlength="100"></textarea>
					</div>
					<div class="form-group">
						<label for="pswd">Votre mot de passe</label>
						<input type="password" class="form-control" id="pswd" name="fPassword" maxlength="45">
					</div>
					<div class="form-group">
						<label for="pswd2">Confirmez votre mot de passe</label>
						<input type="password" class="form-control" id="pswd2" name="fPassword2" maxlength="45">
					</div>
